        ...
        try {
            when (step) {
                0 -> {
                    ...
                    server = ScapesServer(
                        source, serverConfigMap, serverInfo,
                ...
                1 -> {
                    ...
                    server.connections.addConnection { worker, connection ->
                        ...
                        val player = LocalPlayerConnection(
                            worker,
                            server.connection, skin, loadingRadius
                        )
            ...
            onError(e.message ?: e::class.java.simpleName, null, null)
            step = -1
        }
    }
