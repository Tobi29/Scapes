...
import scapes.plugin.tobi29.vanilla.basics.entity.client.EntityBellowsClient
...
class EntityModelBellows(shared: EntityModelBellowsShared,
    ...
    override fun renderUpdate(delta: Double) {
        ...
        scale += (diff(scale.toDouble(),
                ((if (value > 1.0f) 2.0f - value else value) * 0.4f + 0.4f).toDouble(),
                2.0) * factor).toFloat()
        scale %= 2f
    }
