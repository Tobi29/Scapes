...
import scapes.plugin.tobi29.vanilla.basics.packet.PacketOpenCrafting

class BlockCraftingTable(materials: VanillaMaterial) : VanillaBlock(materials,
        "vanilla.basics.block.CraftingTable") {
