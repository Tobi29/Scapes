...
open class GuiContainerInventory<out T : EntityContainerClient>(name: String, player: MobPlayerClientMainVB,
                                                                protected val container: T, style: GuiStyle) : GuiInventory(
        name, player, style) {
