...
import scapes.plugin.tobi29.vanilla.basics.gui.GuiAnvilInventory

class EntityAnvilClient constructor(world: WorldClient, pos: Vector3d = Vector3d.ZERO) : EntityAbstractContainerClient(
