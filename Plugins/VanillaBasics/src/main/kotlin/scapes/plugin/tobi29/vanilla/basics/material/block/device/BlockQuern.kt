...
import scapes.plugin.tobi29.vanilla.basics.entity.server.EntityQuernServer
...
class BlockQuern(materials: VanillaMaterial) : VanillaBlockContainer(materials,
        "vanilla.basics.block.Quern") {
    ...
    override fun placeEntity(terrain: TerrainServer,
        ...
        val entity = EntityQuernServer(terrain.world,
