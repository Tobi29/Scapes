...
public class VanillaMaterial {
    ...
    public final ItemFlintTool flintAxe;
    public final ItemFlintTool flintHammer;
    public final ItemFlintTool flintHoe;
    public final ItemFlintTool flintPickaxe;
    public final ItemFlintTool flintSaw;
    public final ItemFlintTool flintShovel;
    public final ItemFlintTool flintSword;
    ...
    public VanillaMaterial(VanillaBasics plugin, GameRegistry registry,
        ...
        flintAxe = register(new ItemFlintAxe(this));
        flintHammer = register(new ItemFlintHammer(this));
        flintHoe = register(new ItemFlintHoe(this));
        flintPickaxe = register(new ItemFlintPickaxe(this));
        ...
        flintSaw = register(new ItemFlintSaw(this));
        flintShovel = register(new ItemFlintShovel(this));
        flintSword = register(new ItemFlintSword(this));
