...
import org.tobi29.scapes.vanilla.basics.gui.GuiChestInventory;

import java.util.Optional;

public class EntityChestClient extends EntityAbstractContainerClient {
    public EntityChestClient(WorldClient world) {
        this(world, Vector3d.ZERO);
    }

    public EntityChestClient(WorldClient world, Vector3 pos) {
