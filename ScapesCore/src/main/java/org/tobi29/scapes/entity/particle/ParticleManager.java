...
public class ParticleManager {
    ...
    public void render(GL gl, Cam cam) {
        ...
        synchronized (particles) {
            Streams.of(particles).sorted((particle1, particle2) -> {
                double distance1 =
    ...
    public void update(double delta) {
        ...
        Streams.of(particles).forEach(particle -> particle.update(delta));
        Streams.of(particles).forEach(particle -> particle.move(delta));
    }
