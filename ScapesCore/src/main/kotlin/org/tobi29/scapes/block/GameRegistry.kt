...
class GameRegistry(private val idStorage: IDStorage) {
    ...
    fun registerMaterial(material: Material) {
        ...
        val id = idStorage["Core", "Material", nameID,
    ...
    inner class Registry<E : Any>(private val module: String,
        ...
        fun reg(element: E,
            ...
            val id = idStorage[module, type, name, min, max]
