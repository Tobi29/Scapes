...
class ParticleEmitterRain(
    system: ParticleSystem,
    texture: Texture
) : ParticleEmitterInstanced<ParticleInstance>(
    ...
    override fun prepareShader(
        gl: GL,
        width: Int,
        height: Int,
        cam: Cam
    ): suspend () -> ((Shader) -> Unit) -> Unit {
    ...
    companion object {
        ...
        private fun createAttributes(): List<ModelAttribute> {
            ...
            attributes.add(
                ModelAttribute(
                    GL.COLOR_ATTRIBUTE, 4,
                    floatArrayOf(
                        0.0f, 0.3f, 0.5f, 0.6f, 0.0f, 0.3f, 0.5f,
                        0.0f
                    ),
        ...
        private fun createAttributesStream(): List<ModelAttribute> {
            ...
            attributes.add(
                ModelAttribute(
                    4, 2, EMPTY_FLOAT, false, 1,
                    VertexType.FLOAT
                )
            )
            attributes.add(
                ModelAttribute(
                    5, 4, EMPTY_FLOAT, false, 1,
                    VertexType.FLOAT
                )
            )
            attributes.add(
                ModelAttribute(
                    6, 4, EMPTY_FLOAT, false, 1,
                    VertexType.FLOAT
                )
            )
            attributes.add(
                ModelAttribute(
                    7, 4, EMPTY_FLOAT, false, 1,
                    VertexType.FLOAT
                )
            )
            attributes.add(
                ModelAttribute(
                    8, 4, EMPTY_FLOAT, false, 1,
                    VertexType.FLOAT
                )
            )
            return attributes
