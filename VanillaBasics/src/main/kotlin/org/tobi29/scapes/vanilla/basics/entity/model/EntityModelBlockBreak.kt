...
class EntityModelBlockBreak(
    shared: EntityModelBlockBreakShared,
    override val entity: EntityBlockBreakClient
) : EntityModel {
    ...
    override fun renderUpdate(delta: Double) {
        ...
        val block = terrain.block(
            pos.x.floorToInt(),
            pos.y.floorToInt(),
            pos.z.floorToInt()
        )
        terrain.type(block).addPointerCollision(
            terrain.data(block),
            pointerPanes,
            pos.x.floorToInt(),
            pos.y.floorToInt(),
