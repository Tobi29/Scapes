...
public class BlockOreGold extends BlockOre {
    public BlockOreGold(VanillaMaterial materials,
            GameRegistry.Registry<StoneType> stoneRegistry) {
        super(materials, "vanilla.basics.block.OreGold", stoneRegistry);
    }
    ...
    public boolean destroy(TerrainServer.TerrainMutable terrain, int x, int y,
        ...
        if ("Pickaxe".equals(item.getMaterial().getToolType(item)) &&
            ...
            terrain.getWorld()
                    .dropItem(new ItemStack(materials.oreChunk, (short) 7),
    ...
    public List<ItemStack> getDrops(ItemStack item, int data) {
        if ("Pickaxe".equals(item.getMaterial().getToolType(item)) &&
            ...
            return Arrays.asList(new ItemStack(materials.oreChunk, (short) 7),
    ...
    public String getName(ItemStack item) {
        return getStoneName(item) + " Gold Ore";
    }
