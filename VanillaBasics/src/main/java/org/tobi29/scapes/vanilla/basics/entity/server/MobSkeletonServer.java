...
public class MobSkeletonServer extends MobLivingEquippedServer {
    private double lookWait, walkWait, hitWait;

    public MobSkeletonServer(WorldServer world) {
        this(world, Vector3d.ZERO, Vector3d.ZERO, 0.0, 0.0);
    }

    public MobSkeletonServer(WorldServer world, Vector3 pos, Vector3 speed,
