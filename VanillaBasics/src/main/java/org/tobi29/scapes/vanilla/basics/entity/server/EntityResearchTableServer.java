...
public class EntityResearchTableServer extends EntityAbstractContainerServer {
    public EntityResearchTableServer(WorldServer world) {
        this(world, Vector3d.ZERO);
    }

    public EntityResearchTableServer(WorldServer world, Vector3 pos) {
    ...
    public boolean isValidOn(TerrainServer terrain, int x, int y, int z) {
        ...
        return terrain.getBlockType(x, y, z) == materials.researchTable;
    }
}
