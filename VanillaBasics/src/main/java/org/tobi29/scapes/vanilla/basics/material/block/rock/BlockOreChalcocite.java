...
public class BlockOreChalcocite extends BlockOre {
    public BlockOreChalcocite(VanillaMaterial materials,
            GameRegistry.Registry<StoneType> stoneRegistry) {
        super(materials, "vanilla.basics.block.OreChalcocite", stoneRegistry);
    }
    ...
    public List<ItemStack> getDrops(ItemStack item, int data) {
        if ("Pickaxe".equals(item.getMaterial().getToolType(item)) &&
            ...
            return Arrays.asList(new ItemStack(materials.oreChunk, (short) 1),
    ...
    public String getName(ItemStack item) {
        return getStoneName(item) + " Chalcocite Ore";
    }
