...
public class EntityAnvilServer extends EntityAbstractContainerServer {
    public EntityAnvilServer(WorldServer world) {
        this(world, Vector3d.ZERO);
    }

    public EntityAnvilServer(WorldServer world, Vector3 pos) {
