...
public class BlockStoneTotem extends BlockStone {
    public BlockStoneTotem(VanillaMaterial materials,
            GameRegistry.Registry<StoneType> stoneRegistry) {
        super(materials, "vanilla.basics.block.StoneTotem", stoneRegistry);
    }
    ...
    public String getName(ItemStack item) {
        return "Fancy " + getStoneName(item) + " Stone";
    }
}
