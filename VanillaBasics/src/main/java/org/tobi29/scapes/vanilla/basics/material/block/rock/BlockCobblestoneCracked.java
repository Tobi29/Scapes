...
public class BlockCobblestoneCracked extends BlockStone {
    public BlockCobblestoneCracked(VanillaMaterial materials,
            GameRegistry.Registry<StoneType> stoneRegistry) {
        super(materials, "vanilla.basics.block.CobblestoneCracked",
                stoneRegistry);
    }
