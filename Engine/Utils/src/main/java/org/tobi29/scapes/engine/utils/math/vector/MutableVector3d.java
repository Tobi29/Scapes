...
public class MutableVector3d extends MutableVector3 {
    ...
    public MutableVector3d(Vector3 vector) {
        this(vector.doubleX(), vector.doubleY(), vector.doubleZ());
    }

    public MutableVector3d(MutableVector3 vector) {
        this(vector.doubleX(), vector.doubleY(), vector.doubleZ());
    }
